...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("server=bdprcdpsql20.intracoomeva.com.co\\PRCDPSQL20,49429;Database=IntegraDigex;Uid=integradigex_app;Pwd=Prue*1ntrD3x");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AntoCliente>(entity =>
            {
                ...
                entity.Property(e => e.ConsCliente).HasDefaultValueSql("(NEXT VALUE FOR [ANTO_CLIENTE_SEQ])");
            ...
            modelBuilder.Entity<AntoInventario>(entity =>
            {
                ...
                entity.Property(e => e.ConsInventario).HasDefaultValueSql("(NEXT VALUE FOR [ANTO_INVENTARIO_SEQ])");
            ...
            modelBuilder.Entity<AntoProducto>(entity =>
            {
                ...
                entity.Property(e => e.ConsProducto).HasDefaultValueSql("(NEXT VALUE FOR [ANTO_PRODUCTO_SEQ])");
            ...
            modelBuilder.Entity<AntoVentum>(entity =>
            {
                ...
                entity.Property(e => e.ConsVenta).HasDefaultValueSql("(NEXT VALUE FOR [ANTO_VENTA_SEQ])");
